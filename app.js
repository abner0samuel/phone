...
//     const searchInput = document.querySelector(".body > .mainContainer > .header > .header1 > input");
...
//     // Function to filter and render the items
...
function searchProducts() {
    ...
    const productList = document.getElementsByClassName('.thumbnail');
